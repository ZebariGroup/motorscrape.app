...
- Known platforms currently include **Dealer.com**, **DealerOn**, **Dealer Inspire**, **CDK / DealerFire**, **Team Velocity**, **D2C Media / AutoAubaine**, **fusionZONE**, **Shift Digital**, **PureCars**, **Jazel**, **FoxDealer**, and **Sincro Digital**.
