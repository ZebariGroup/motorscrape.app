...
- Always populate `make` with the brand when the listing is for a single-brand dealer,
  even if the visible title only shows model lines (e.g. "320d M Sport" → make BMW).
