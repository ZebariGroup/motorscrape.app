...
_HANDLERS = {
    ...
    "cdk_dealerfire": cdk_dealerfire.extract_inventory,
    ...
    "team_velocity": team_velocity.extract_inventory,
    ...
    "fusionzone": fusionzone.extract_inventory,
    "shift_digital": shift_digital.extract_inventory,
    "purecars": purecars.extract_inventory,
    "jazel": jazel.extract_inventory,
    "foxdealer": foxdealer.extract_inventory,
    "sincro_digital": sincro_digital.extract_inventory,
